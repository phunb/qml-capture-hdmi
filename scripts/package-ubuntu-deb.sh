...
install -m 0755 "$LINUX_DIR/start-kiosk.sh" "$STAGE/opt/hdmi-kiosk/bin/start-kiosk"
install -m 0755 "$LINUX_DIR/start-kiosk.sh" "$STAGE/opt/hdmi-kiosk/share/start-kiosk.sh"
